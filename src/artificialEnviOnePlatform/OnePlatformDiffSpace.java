...
public class OnePlatformDiffSpace {
	...
	public static void main(String[] args) throws IOException {
		...
		String mainDir = "initialRuns\\onePlatform\\DifferentSpace\\" + area + "sqkm\\" + passDist + vehDist + "\\";
...
//					System.out.println("passengers done: " + passengers.size());
					...
					for (int k = 1 ; k <= iterations ; k++)
					{
						...
						vehicles = Generators.vehicleLocalGenerator(vehDist, vehAddedInIteration, operators, xLimit, yLimit, vehicleCapacity);
...
//								matchedVehPercent [o] = 0;
					    ...
					    for (int o = 0 ; o < operators.size() ; o++)
					    {
							if(meanVehUtil[o] < vehUtilLowerThres)
								vehAddedInIteration[o] *= 0.95;
							else if (meanVehUtil[o] >= vehUtilUpperThres)
								vehAddedInIteration[o] *= 1.05;
					    }
